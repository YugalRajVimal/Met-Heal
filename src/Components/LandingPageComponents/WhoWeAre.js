...
// For dark color use text-green-600
const WHO_SERVICES = [
  ...
  { icon: <FaUserFriends className="text-green-600 w-5 h-5" />, label: "Patient Companions" },
  ...
  { icon: <FaFileInvoice className="text-green-600 w-5 h-5" />, label: "Billing & Paperwork" },
];
  ...
  return (
    <section className=" py-12 md:py-24 w-full  mx-auto px-4 md:px-8 bg-lime-50">
      ...
      <div className="flex-1 max-w-xl">
        <span className="inline-flex items-center px-4 py-1 rounded-full text-sm font-medium bg-lime-100 text-green-600 mb-4">
          • Who We Are
        </span>
        <h1 className="text-green-600 font-serif text-3xl md:text-5xl font-semibold tracking-tight mb-6">
        ...
        <div>
          ...
          <ul className="grid grid-cols-2 gap-x-4 gap-y-3 text-green-600 text-base">
      ...
      <div className="flex-1 flex justify-center items-center w-full h-72 md:h-[420px] relative">
        <div className="w-64 h-64 md:w-[420px] md:h-[520px] rounded-3xl shadow-xl flex items-center justify-center bg-lime-100">
          <img src="/images/03.png" className="h-full w-full rounded-xl object-cover shadow-md" alt="Medical support illustration" />
        </div>
      </div>
      </div>
